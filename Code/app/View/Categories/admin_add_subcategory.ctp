   ...
   <div class="row">        
      <?php echo $this->Form->create(null, array('url' => array('controller' => 'categories', 'action' => 'add_subcategory',$parentCatId),'id'=>'categoryId'));              
         ...
         <div class="col-lg-12">
            <div class="form-group form-spacing">
               ...
               <div class="col-lg-8 form-box">                
                  <?php echo $this->Form->input('category',array('label' => false,'div' => false, 'placeholder' => 'Category Name','class' => 'form-control','maxlength' => 55));?>
               </div>
            </div>
         </div>      
         <div class="col-lg-12">
